...
## Business Problem
An e-commerce company wants to understand: Which customer cohorts have the
...
serving 50+ stakeholders. This project applies the same analytical thinking
to customer retention — the pattern is identical.
